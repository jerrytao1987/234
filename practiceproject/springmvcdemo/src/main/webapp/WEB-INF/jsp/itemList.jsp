...
<tr>
	...
	<td><input type="text" name="itemList[${vs.index }].createtime" value="<fmt:formatDate value="${item.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"></td>
	<td><img style="width:80px;height:80px" src="http://localhost:8080/pic/${item.pic }" /></td>
