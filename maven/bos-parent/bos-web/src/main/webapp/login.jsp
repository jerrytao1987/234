			...
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform"
					...
					<div class="loginFormIpt loginFormIptWiotTh"
						...
						<a onclick="document.getElementById('loginform').submit();" href="javascript:void(0)" id="loginform:j_id19" name="loginform:j_id19">
						<span
							id="loginform:loginBtn" class="btn btn-login"
							style="margin-top:-36px;" >登录</span>
						</a>
					</div>
					<div style="color:red;text-align:center;"><br/><s:actionerror/></div>
				</form>
			</div>
		</div>
	</div>
