...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#tabs').tabs('add', {
			title : '消息中心',
			content :'<div id="subWarp"	style="width:100%;height:100%;overflow:hidden">'+
		...
		$('#tabs').tabs({
			onSelect:function(title,index){
						...
						var url = $(select.panel('options').content).find('iframe').attr('src');
					    $('#tabs').tabs("update",{
							tab:select,
							options:{
								title:title, 
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" type="Password" class="txt01 easyui-validatebox" required="true" data-options="validType:'length[4,6]'" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" type="Password" class="txt01 easyui-validatebox"  required="true" data-options="validType:'length[4,6]'" /></td>
                    </tr>
                </table>
                </form>
            </div>
