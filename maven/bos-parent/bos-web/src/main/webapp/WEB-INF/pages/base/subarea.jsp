...
<script type="text/javascript">
	...
	function doExport(){
		window.location.href="subareaAction_exportXml";
	}
	...
	function doShowHighcharts(){
		...
		$.post("subareaAction_findSubareasGroupByProvince",function(data){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 展示区域分布图 -->
	<div class="easyui-window" title="展示区域分布图" id="showSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px;">
		<div id="test"></div>
	</div>
	<!-- 查询分区 -->
