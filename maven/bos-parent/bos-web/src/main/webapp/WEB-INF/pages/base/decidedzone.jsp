...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1 ){
			...
			var url_1 = "decidedzoneAction_findListNotAssociation";
			...
			var url_2 = "decidedzoneAction_findListHasAssociation";
	...
	function doDblClickRow(index,row){
		$('#association_subarea').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "subareaAction_findListByDecidedzoneId?decidedzone.id="+row.id,
			columns : [ [{
				field : 'id',
				title : '分拣编号',
				width : 120,
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "decidedzoneAction_findListHasAssociation?id="+row.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
			...
			<form id="addDecidedzoneForm" method="post" action="decidedzoneAction_add">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>选择负责人</td>
						<td>
							<input id="cc" class="easyui-combobox" name="staff.id"  
