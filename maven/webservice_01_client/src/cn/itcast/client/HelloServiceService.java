 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://webservice.itheima.com/", wsdlLocation = "http://192.168.0.104/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://webservice.itheima.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.104/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://webservice.itheima.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.itheima.com/", "HelloServicePort"), HelloService.class, features);
    }
