        ...
        <TR>
          ...
          <TD>
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                <TD style="HEIGHT: 18px" colspan="2"><span style="color:#ff6d9a"><s:property value="#error"/></span></TD>
                <TD style="HEIGHT: 18px"></TD></TR>
              <TR>
                <TD colspan="2"><INPUT id=registbtn 
                  style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" 
                  type=image src="images/regist_button.png" name=registbtn> 
                  <image style="cursor:pointer;" src="images/login_button.gif" name=loginbtn onclick="window.location.href='${pageContext.request.contextPath}/login.jsp';"> 
