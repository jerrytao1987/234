					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<input type="hidden" name="customer.cust_id" id="cust_id" style="WIDTH: 180px" value="<s:property value='#linkMan.customer.cust_id'/>"/>
									<input type="text"  id="cust_name" style="WIDTH: 180px" value="<s:property value='#linkMan.customer.cust_name'/>" readonly="true" />
							...
							<TR>
								<td>联系人名称：</td>
								<td>
								<INPUT class=textbox id=sChannel2 value="<s:property value='#linkMan.lkm_name'/>"
