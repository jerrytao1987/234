			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/user?method=register" method="post" style="margin-top: 5px;">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								name="sex" id="sex1" value="mail">
								男
							</label> <label class="radio-inline"> <input type="radio"
								name="sex" id="sex2" value="femail">
								女
							</label>
							<label class="error radio-inline" for="sex" style="display:none">请选择性别</label>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2" >
							<img id="codeImg"  src="${pageContext.request.contextPath }/checkImg" onclick="changeImg(this);" />
						</div>
