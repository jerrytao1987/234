			...
			<div class="col-md-10">
				...
				<c:forEach items="${hotProductList }" var="hotProduct">
					<div class="col-md-2"
						...
						<a href="product_info.htm"> <img
							src="${pageContext.request.contextPath }/${hotProduct.pimage }" width="130" height="130"
							style="display: inline-block;">
						</a>
						<p>
							<a href="product_info.html" style='color: #666'>${hotProduct.pname }</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${hotProduct.shop_price }</font>
						</p>
					</div>
				</c:forEach>
			...
			<div class="col-md-10">
				...
				<c:forEach items="${newProductList }" var="newProduct">
					<div class="col-md-2"
						style="text-align: center; height: 200px; padding: 10px 0px;">
						<a href="product_info.htm"> <img
							src="${pageContext.request.contextPath }/${newProduct.pimage }" width="130" height="130"
							style="display: inline-block;">
						</a>
						<p>
							<a href="product_info.html" style='color: #666'>${newProduct.pname }</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${newProduct.shop_price }</font>
						</p>
					</div>
				</c:forEach>
			</div>
